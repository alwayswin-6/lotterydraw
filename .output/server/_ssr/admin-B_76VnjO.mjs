...
function AdminPage() {
	...
	const [vehicles, setLotteryPrizes] = (0, import_react.useState)([]);
	...
	const refreshData = async () => {
		...
		try {
			setLotteryPrizes(await apiGet("/api/vehicles"));
		} catch (error) {
			console.error(error);
			setUploadError("Could not load prizes from the database.");
		}
		try {
			setNews(await apiGet("/api/news"));
		} catch (error) {
			console.error(error);
		}
		try {
	...
	const addLotteryPrize = async (event) => {
		...
		try {
			...
			const drawLocation = formData.get("drawLocation");
			if (drawLocation) {
			...
			if (detailsPackageFile) formData.append("detailsPackage", detailsPackageFile, detailsPackageFile.name);
			...
			const nextLotteryPrizes = [await response.json(), ...vehicles];
	...
	const removeLotteryPrize = async (id) => {
		try {
	...
	const addNews = async (event) => {
		...
		const newsItem = {
			...
			category: String(formData.get("category") || "update"),
			image: String(formData.get("image") || ""),
			link: String(formData.get("link") || "") || void 0
		};
		try {
			const response = await apiSend("/api/news", "POST", newsItem);
	...
	const deleteNews = async (id) => {
		...
		try {
			await apiSend("/api/news", "DELETE", { id });
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPanel, {
							title: "Add Lottery Prize",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
								onSubmit: addLotteryPrize,
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										name: "odds",
										placeholder: "Odds (e.g., 1 in 50,000,000)",
										className: "admin-field"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										name: "ticketPrice",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "",
												children: "Select Lottery Draw Location..."
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.powerball.com",
												children: "Powerball (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.megamillions.com",
												children: "Mega Millions (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.calottery.com",
												children: "California Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://nylottery.ny.gov",
												children: "New York Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.txlottery.org",
												children: "Texas Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.flalottery.com",
												children: "Florida Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.illinoislottery.com",
												children: "Illinois Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.ohiolottery.com",
												children: "Ohio Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.michiganlottery.com",
												children: "Michigan Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.palottery.com",
												children: "Pennsylvania Lottery (USA)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.national-lottery.co.uk",
												children: "National Lottery (UK)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.ozlotteries.com",
												children: "Oz Lotteries (Australia)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.loto-quebec.com",
												children: "Loto-Québec (Canada)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.bclc.com",
												children: "BC Lottery (Canada)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "https://www.olg.ca",
												children: "Ontario Lottery (Canada)"
											})
										]
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: savingLotteryPrize ? "Uploading..." : "Add Lottery Prize"
									})
								]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPanel, {
							title: "Current Lottery Prizes",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPanel, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
									...
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: news.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										className: "bg-white/[0.055] align-top",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												className: "rounded-l-xl px-3 py-3",
