		...
		return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
			...
			if (socketPath) {
				...
				if (allowedSocketPaths != null) {
					...
					const resolvedSocket = path$2.resolve(socketPath);
					if (!allowed.some((entry) => typeof entry === "string" && path$2.resolve(entry) === resolvedSocket)) return reject(new AxiosError(`socketPath "${socketPath}" is not permitted by allowedSocketPaths`, AxiosError.ERR_BAD_OPTION_VALUE, config));
				}
...
//#endregion
//#region node_modules/@sendgrid/client/package.json
var package_exports = /* @__PURE__ */ __exportAll({
	...
	tags: () => tags,
	version: () => version
}), name, description, version, author, contributors, homepage, repository, publishConfig, main, engines, dependencies, devDependencies, resolutions, tags, gitHead, package_default;
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/convert-keys.js
var require_convert_keys = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Helper to convert an object's keys
	*/
	module.exports = function convertKeys(obj, converter, ignored) {
		if (typeof obj !== "object" || obj === null) throw new Error("Non object passed to convertKeys: " + obj);
 ...
 //istanbul ignore else
		if (obj.hasOwnProperty(key)) {
			...
			if (typeof obj[key] === "object" && obj[key] !== null) {
				if (!ignored.includes(key) && !ignored.includes(converted)) obj[key] = convertKeys(obj[key], converter, ignored);
			}
			if (converted !== key) {
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/str-to-camel-case.js
var require_str_to_camel_case = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Internal conversion helper
	*/
	module.exports = function strToCamelCase(str) {
		if (typeof str !== "string") throw new Error("String expected for conversion to snake case");
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/to-camel-case.js
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/str-to-snake-case.js
var require_str_to_snake_case = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Internal conversion helper
	*/
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/to-snake-case.js
var require_to_snake_case = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Dependencies
	*/
	var convertKeys = require_convert_keys();
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/deep-clone.js
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/attachment.js
var require_attachment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Dependencies
	*/
	...
	*/
	var Attachment = class {
		...
		*/
		fromData(data) {
			if (typeof data !== "object") throw new Error("Expecting object for Mail data");
			data = deepClone(data);
			data = toCamelCase(data);
			const { content, filename, type, disposition, contentId, filePath } = data;
			if (typeof content !== "undefined" && typeof filePath !== "undefined") throw new Error("The props 'content' and 'filePath' cannot be used together.");
		...
		*/
		setContent(content) {
			if (typeof content === "string") {
				...
				if (this.disposition === "attachment") this.content = content.toString("base64");
				return;
			}
		...
		*/
		setFilename(filename) {
			...
			if (filename && typeof filename !== "string") throw new Error("String expected for `filename`");
		...
		*/
		setType(type) {
			...
			if (typeof type !== "string") throw new Error("String expected for `type`");
			this.type = type;
		}
		/**
		* Set disposition
		*/
		setDisposition(disposition) {
			if (typeof disposition === "undefined") return;
			if (typeof disposition !== "string") throw new Error("String expected for `disposition`");
		...
		*/
		setContentId(contentId) {
			if (typeof contentId === "undefined") return;
			if (typeof contentId !== "string") throw new Error("String expected for `contentId`");
		...
		*/
		toJSON() {
			...
			if (typeof type !== "undefined") json.type = type;
			if (typeof disposition !== "undefined") json.disposition = disposition;
			if (typeof contentId !== "undefined") json.contentId = contentId;
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/split-name-email.js
var require_split_name_email = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/email-address.js
var require_email_address = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Dependencies
	*/
	...
	module.exports = class EmailAddress {
		...
		*/
		fromData(data) {
			...
			if (typeof data !== "object") throw new Error("Expecting object or string for EmailAddress data");
		...
		*/
		setName(name) {
			...
			if (typeof name !== "string") throw new Error("String expected for `name`");
			this.name = name;
		}
		/**
		* Set email (mandatory)
		*/
		setEmail(email) {
			if (typeof email === "undefined") throw new Error("Must provide `email`");
			if (typeof email !== "string") throw new Error("String expected for `email`");
			this.email = email;
		}
		/**
		* To JSON
		...
		*/
		static create(data) {
			if (Array.isArray(data)) return data.filter((item) => !!item).map((item) => this.create(item));
			if (data instanceof EmailAddress) return data;
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/wrap-substitutions.js
var require_wrap_substitutions = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Wrap substitutions
	*/
	module.exports = function wrap(substitutions, left = "{{", right = "}}") {
		if (Array.isArray(substitutions)) return substitutions.map((subs) => wrap(subs, left, right));
		const wrapped = {};
		for (const key in substitutions)
 //istanbul ignore else
		if (substitutions.hasOwnProperty(key)) wrapped[left + key + right] = String(substitutions[key]);
		return wrapped;
	};
}));
//#endregion
//#region node_modules/@sendgrid/helpers/classes/personalization.js
var require_personalization = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Dependencies
	*/
	...
	var Personalization = class {
		...
		*/
		setSubject(subject) {
			...
			if (typeof subject !== "string") throw new Error("String expected for `subject`");
		...
		*/
		setSendAt(sendAt) {
			if (typeof sendAt === "undefined") return;
			if (!Number.isInteger(sendAt)) throw new Error("Integer expected for `sendAt`");
			this.sendAt = sendAt;
		}
		/**
		* Set to
		...
		*/
		setBcc(bcc) {
			if (typeof bcc === "undefined") return;
		...
		*/
		setHeaders(headers) {
			...
			if (typeof headers !== "object" || headers === null) throw new Error("Object expected for `headers`");
		...
		*/
		addHeader(key, value) {
			if (typeof key !== "string") throw new Error("String expected for header key");
			if (typeof value !== "string") throw new Error("String expected for header value");
		...
		*/
		setCustomArgs(customArgs) {
			if (typeof customArgs === "undefined") return;
			if (typeof customArgs !== "object" || customArgs === null) throw new Error("Object expected for `customArgs`");
		...
		*/
		addCustomArg(key, value) {
			if (typeof key !== "string") throw new Error("String expected for custom arg key");
			if (typeof value !== "string") throw new Error("String expected for custom arg value");
		...
		*/
		setSubstitutions(substitutions) {
			...
			if (typeof substitutions !== "object") throw new Error("Object expected for `substitutions`");
		...
		*/
		addSubstitution(key, value) {
			if (typeof key !== "string") throw new Error("String expected for substitution key");
			if (typeof value !== "string" && typeof value !== "number") throw new Error("String or Number expected for substitution value");
		...
		*/
		reverseMergeSubstitutions(substitutions) {
			...
			if (typeof substitutions !== "object") throw new Error("Object expected for `substitutions` in reverseMergeSubstitutions");
		...
		*/
		setSubstitutionWrappers(wrappers) {
			if (typeof wrappers === "undefined" || wrappers === null) return;
			if (!Array.isArray(wrappers) || wrappers.length !== 2) throw new Error("Array expected with two elements for `substitutionWrappers`");
		...
		*/
		deepMergeDynamicTemplateData(dynamicTemplateData) {
			if (typeof dynamicTemplateData === "undefined" || dynamicTemplateData === null) return;
			if (typeof dynamicTemplateData !== "object") throw new Error("Object expected for `dynamicTemplateData` in deepMergeDynamicTemplateData");
		...
		*/
		setDynamicTemplateData(dynamicTemplateData) {
			if (typeof dynamicTemplateData === "undefined") return;
			if (typeof dynamicTemplateData !== "object") throw new Error("Object expected for `dynamicTemplateData`");
		...
		*/
		toJSON() {
			...
			const json = { to };
			if (Array.isArray(cc) && cc.length > 0) json.cc = cc;
			if (Array.isArray(bcc) && bcc.length > 0) json.bcc = bcc;
			...
			if (Object.keys(customArgs).length > 0) json.customArgs = customArgs;
			if (dynamicTemplateData && Object.keys(dynamicTemplateData).length > 0) json.dynamicTemplateData = dynamicTemplateData;
			if (typeof subject !== "undefined") json.subject = subject;
			if (typeof sendAt !== "undefined") json.sendAt = sendAt;
			if (typeof from !== "undefined") json.from = from;
			return toSnakeCase(json, [
				"substitutions",
				"dynamicTemplateData",
				"customArgs",
...
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/array-to-json.js
var require_array_to_json = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Helper to convert an array of objects to JSON
	*/
	module.exports = function arrayToJSON(arr) {
		return arr.map((item) => {
			if (typeof item === "object" && item !== null && typeof item.toJSON === "function") return item.toJSON();
			return item;
		});
	};
}));
//#endregion
//#region node_modules/@sendgrid/helpers/constants/index.js
var require_constants = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = { DYNAMIC_TEMPLATE_CHAR_WARNING: `
Content with characters ', " or & may need to be escaped with three brackets
{{{ content }}}
See https://sendgrid.com/docs/for-developers/sending-email/using-handlebars/ for more information.` };
}));
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/validate-settings.js
var require_validate_settings = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var validate = (parent, parentName, childName, childType) => {
		if (typeof parent === "undefined" || typeof parent[childName] === "undefined") return;
		if (typeof parent[childName] !== childType) throw new Error(`${childType} expected for \`${parentName}.${childName}\``);
	};
	module.exports = {
		validateMailSettings(settings) {
			if (typeof settings !== "object") throw new Error("Object expected for `mailSettings`");
		...
		validateTrackingSettings(settings) {
			if (typeof settings !== "object") throw new Error("Object expected for `trackingSettings`");
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/mail.js
	...
	module.exports = class Mail {
		...
		*/
		fromData(data) {
			...
			if (this.isDynamic) this.setDynamicTemplateData(dynamicTemplateData);
			else {
				this.setSubstitutions(substitutions);
				this.setSubstitutionWrappers(substitutionWrappers);
			}
			...
			if (personalizations) this.setPersonalizations(personalizations);
			else if (isMultiple && Array.isArray(to)) to.forEach((to) => this.addTo(to, cc, bcc));
			else this.addTo(to, cc, bcc);
		}
		/**
		* Set from email
		*/
		setFrom(from) {
			if (this._checkProperty("from", from, [this._checkUndefined])) {
				if (typeof from !== "string" && typeof from.email !== "string") throw new Error("String or address object expected for `from`");
				this.from = EmailAddress.create(from);
			}
		}
		/**
		...
		*/
		setReplyTo(replyTo) {
			if (this._checkProperty("replyTo", replyTo, [this._checkUndefined])) {
				if (typeof replyTo !== "string" && typeof replyTo.email !== "string") throw new Error("String or address object expected for `replyTo`");
		...
		*/
		setSendAt(sendAt) {
			if (this._checkProperty("sendAt", sendAt, [this._checkUndefined, this._createCheckThatThrows(Number.isInteger, "Integer expected for `sendAt`")])) this.sendAt = sendAt;
		}
		/**
		...
		*/
		setTemplateId(templateId) {
			if (this._setProperty("templateId", templateId, "string")) {
				if (templateId.indexOf("d-") === 0) this.isDynamic = true;
			}
		}
		/**
		* Set batch ID
		...
		*/
		setAsm(asm) {
			if (this._checkProperty("asm", asm, [this._checkUndefined, this._createTypeCheck("object")])) {
				if (typeof asm.groupId !== "number") throw new Error("Expected `asm` to include an integer in its `groupId` field");
				if (asm.groupsToDisplay && (!Array.isArray(asm.groupsToDisplay) || !asm.groupsToDisplay.every((group) => typeof group === "number"))) throw new Error("Array of integers expected for `asm.groupsToDisplay`");
				this.asm = asm;
			}
		}
		/**
		...
		*/
		setPersonalizations(personalizations) {
			if (!this._doArrayCheck("personalizations", personalizations)) return;
			if (!personalizations.every((personalization) => typeof personalization === "object")) throw new Error("Array of objects expected for `personalizations`");
			this.personalizations = [];
		...
		*/
		addPersonalization(personalization) {
			if (this.isDynamic && personalization.substitutions) delete personalization.substitutions;
			else if (!this.isDynamic && personalization.dynamicTemplateData) delete personalization.dynamicTemplateData;
			if (!(personalization instanceof Personalization)) personalization = new Personalization(personalization);
			if (this.isDynamic) this.applyDynamicTemplateData(personalization);
			else this.applySubstitutions(personalization);
		...
		*/
		addTo(to, cc, bcc) {
			if (typeof to === "undefined" && typeof cc === "undefined" && typeof bcc === "undefined") throw new Error("Provide at least one of to, cc or bcc");
		...
		*/
		setSubstitutionWrappers(substitutionWrappers) {
			let lengthCheck = (propertyName, value) => {
				if (!Array.isArray(value) || value.length !== 2) throw new Error("Array expected with two elements for `" + propertyName + "`");
			};
			if (this._checkProperty("substitutionWrappers", substitutionWrappers, [this._checkUndefined, lengthCheck])) this.substitutionWrappers = substitutionWrappers;
		}
		/**
		...
		*/
		applyDynamicTemplateData(personalization) {
			if (personalization instanceof Personalization) personalization.deepMergeDynamicTemplateData(this.dynamicTemplateData);
		}
		/**
		...
		*/
		setDynamicTemplateData(dynamicTemplateData) {
			if (typeof dynamicTemplateData === "undefined") return;
			if (typeof dynamicTemplateData !== "object") throw new Error("Object expected for `dynamicTemplateData`");
			if (!this.hideWarnings) Object.values(dynamicTemplateData).forEach((value) => {
				if (/['"&]/.test(value)) console.warn(DYNAMIC_TEMPLATE_CHAR_WARNING);
			});
			this.dynamicTemplateData = dynamicTemplateData;
		}
		/**
		...
		*/
		setContent(content) {
			if (this._doArrayCheck("content", content)) {
				if (!content.every((contentField) => typeof contentField === "object")) throw new Error("Expected each entry in `content` to be an object");
				if (!content.every((contentField) => typeof contentField.type === "string")) throw new Error("Expected each `content` entry to contain a `type` string");
				if (!content.every((contentField) => typeof contentField.value === "string")) throw new Error("Expected each `content` entry to contain a `value` string");
				this.content = content;
			}
		}
		/**
		...
		*/
		addContent(content) {
			if (this._checkProperty("content", content, [this._createTypeCheck("object")])) this.content.push(content);
		}
		/**
		* Add text content
		*/
		addTextContent(text) {
			if (this._checkProperty("text", text, [this._checkUndefined, this._createTypeCheck("string")])) this.addContent({
				value: text,
				type: "text/plain"
			});
		}
		...
		*/
		addHtmlContent(html) {
			if (this._checkProperty("html", html, [this._checkUndefined, this._createTypeCheck("string")])) this.addContent({
				value: html,
				type: "text/html"
			});
		}
		...
		*/
		setAttachments(attachments) {
			if (this._doArrayCheck("attachments", attachments)) {
				if (!attachments.every((attachment) => typeof attachment.content === "string")) throw new Error("Expected each attachment to contain a `content` string");
				if (!attachments.every((attachment) => typeof attachment.filename === "string")) throw new Error("Expected each attachment to contain a `filename` string");
				if (!attachments.every((attachment) => !attachment.type || typeof attachment.type === "string")) throw new Error("Expected the attachment's `type` field to be a string");
				if (!attachments.every((attachment) => !attachment.disposition || typeof attachment.disposition === "string")) throw new Error("Expected the attachment's `disposition` field to be a string");
		...
		*/
		addAttachment(attachment) {
			if (this._checkProperty("attachment", attachment, [this._checkUndefined, this._createTypeCheck("object")])) this.attachments.push(attachment);
		}
		/**
		* Set categories
		*/
		setCategories(categories) {
			let allElementsAreStrings = (propertyName, value) => {
				if (!Array.isArray(value) || !value.every((item) => typeof item === "string")) throw new Error("Array of strings expected for `" + propertyName + "`");
			};
			if (typeof categories === "string") categories = [categories];
			if (this._checkProperty("categories", categories, [this._checkUndefined, allElementsAreStrings])) this.categories = categories;
		}
		/**
		* Add category
		*/
		addCategory(category) {
			if (this._checkProperty("category", category, [this._createTypeCheck("string")])) this.categories.push(category);
		}
		/**
		* Set headers
		*/
		...
		*/
		addHeader(key, value) {
			if (this._checkProperty("key", key, [this._createTypeCheck("string")]) && this._checkProperty("value", value, [this._createTypeCheck("string")])) this.headers[key] = value;
		}
		/**
		* Set sections
		*/
		...
		*/
		setHideWarnings(hide) {
			...
			if (typeof hide !== "boolean") throw new Error("Boolean expected for `hideWarnings`");
		...
		*/
		toJSON() {
			...
			if (Array.isArray(attachments) && attachments.length > 0) json.attachments = arrayToJSON(attachments);
			if (Array.isArray(categories) && categories.length > 0) json.categories = categories.filter((cat) => cat !== "");
			if (Array.isArray(content) && content.length > 0) json.content = arrayToJSON(content);
			if (Object.keys(headers).length > 0) json.headers = headers;
			if (Object.keys(mailSettings).length > 0) json.mailSettings = mailSettings;
			if (Object.keys(trackingSettings).length > 0) json.trackingSettings = trackingSettings;
			if (Object.keys(customArgs).length > 0) json.customArgs = customArgs;
			if (Object.keys(sections).length > 0) json.sections = sections;
			if (Object.keys(asm).length > 0) json.asm = asm;
			if (typeof replyTo !== "undefined") json.replyTo = replyTo;
			if (typeof sendAt !== "undefined") json.sendAt = sendAt;
			if (typeof batchId !== "undefined") json.batchId = batchId;
			if (typeof templateId !== "undefined") json.templateId = templateId;
			if (typeof ipPoolName !== "undefined") json.ipPoolName = ipPoolName;
			if (typeof replyToList !== "undefined") json.replyToList = replyToList;
			return toSnakeCase(json, [
				"substitutions",
				"dynamicTemplateData",
				"customArgs",
		...
		*/
		static create(data) {
			if (Array.isArray(data)) return data.filter((item) => !!item).map((item) => this.create(item));
			if (data instanceof Mail) return data;
		...
		*/
		_setProperty(propertyName, value, propertyType) {
			...
			if (propertyChecksPassed) this[propertyName] = value;
		...
		*/
		_createTypeCheck(propertyType) {
			return (propertyName, value) => {
				if (typeof value !== propertyType) throw new Error(propertyType + " expected for `" + propertyName + "`");
			};
		}
		/**
		...
		*/
		_createCheckThatThrows(check, errorString) {
			return (propertyName, value) => {
				if (!check(value)) throw new Error(errorString);
			};
		}
		/**
		...
		*/
		_setArrayProperty(propertyName, value) {
			if (this._doArrayCheck(propertyName, value)) this[propertyName] = value;
		}
		/**
		...
		*/
		setReplyToList(replyToList) {
			if (this._doArrayCheck("replyToList", replyToList) && replyToList.length) {
				if (!replyToList.every((replyTo) => replyTo && typeof replyTo.email === "string")) throw new Error("Expected each replyTo to contain an `email` string");
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/response.js
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/response-error.js
	...
	var ResponseError = class extends Error {
		...
		*/
		toString() {
			...
			if (body && Array.isArray(body.errors)) body.errors.forEach((error) => {
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/statistics.js
var require_statistics = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Dependencies
	*/
	var toCamelCase = require_to_camel_case();
	...
	*/
	var Statistics = class {
		...
		*/
		fromData(data) {
			if (typeof data !== "object") throw new Error("Expecting object for Statistics data");
			data = deepClone(data);
		...
		*/
		setStartDate(startDate) {
			if (typeof startDate === "undefined") throw new Error("Date expected for `startDate`");
			if (new Date(startDate) === "Invalid Date" || isNaN(new Date(startDate))) throw new Error("Date expected for `startDate`");
		...
		*/
		setEndDate(endDate) {
			...
			if (new Date(endDate) === "Invalid Date" || isNaN(new Date(endDate))) throw new Error("Date expected for `endDate`");
		...
		*/
		setAggregatedBy(aggregatedBy) {
			if (typeof aggregatedBy === "undefined") return;
			if (typeof aggregatedBy === "string" && AggregatedByOptions.includes(aggregatedBy.toLowerCase())) this.aggregatedBy = aggregatedBy;
		...
		*/
		getAdvanced(country) {
			...
			if (typeof country === "undefined") return json;
			if (typeof country === "string" && CountryOptions.includes(country.toLowerCase())) json.country = country;
			return json;
		}
		/**
		...
		*/
		getAdvancedMailboxProviders(mailBoxProviders) {
			const json = this.getGlobal();
			if (typeof mailBoxProviders === "undefined") return json;
			if (Array.isArray(mailBoxProviders) && mailBoxProviders.some((x) => typeof x !== "string")) throw new Error("Array of strings expected for `mailboxProviders`");
		...
		*/
		getAdvancedBrowsers(browsers) {
			const json = this.getGlobal();
			if (typeof browsers === "undefined") return json;
			if (Array.isArray(browsers) && browsers.some((x) => typeof x !== "string")) throw new Error("Array of strings expected for `browsers`");
		...
		*/
		getCategories(categories) {
			if (typeof categories === "undefined") throw new Error("Array of strings expected for `categories`");
			if (!this._isValidArrayOfStrings(categories)) throw new Error("Array of strings expected for `categories`");
			const json = this.getGlobal();
		...
		*/
		getSubuser(subusers) {
			if (typeof subusers === "undefined") throw new Error("Array of strings expected for `subusers`");
			if (!this._isValidArrayOfStrings(subusers)) throw new Error("Array of strings expected for `subusers`");
			const json = this.getGlobal();
		...
		*/
		getSubuserSum(sortByMetric = "delivered", sortByDirection = SortByDirection[0], limit = 5, offset = 0) {
			if (typeof sortByMetric !== "string") throw new Error("string expected for `sortByMetric`");
			if (!SortByDirection.includes(sortByDirection.toLowerCase())) throw new Error("desc or asc expected for `sortByDirection`");
			if (typeof limit !== "number") throw new Error("number expected for `limit`");
			if (typeof offset !== "number") throw new Error("number expected for `offset`");
			const json = this.getGlobal();
		...
		*/
		...
		_isValidArrayOfStrings(arr) {
			...
			if (arr.length < 1 || arr.some((x) => typeof x !== "string")) return false;
			return true;
		}
	};
...
//#endregion
//#region node_modules/@sendgrid/helpers/classes/index.js
var require_classes = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Export
	*/
	module.exports = {
		Attachment: require_attachment(),
		EmailAddress: require_email_address(),
		Mail: require_mail(),
		Personalization: require_personalization(),
		Response: require_response(),
		ResponseError: require_response_error(),
		Statistics: require_statistics()
	};
}));
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/merge-data.js
var require_merge_data = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Merge data helper
	*/
	module.exports = function mergeData(base, data) {
		if (typeof base !== "object" || base === null) throw new Error("Not an object provided for base");
		if (typeof data !== "object" || data === null) throw new Error("Not an object provided for data");
		const merged = Object.assign({}, base);
		for (const key in data)
 //istanbul ignore else
		if (data.hasOwnProperty(key)) {
			if (data[key] && Array.isArray(data[key])) merged[key] = data[key];
			else if (data[key] && typeof data[key] === "object") merged[key] = Object.assign({}, data[key]);
			else if (data[key]) merged[key] = data[key];
		}
		return merged;
	};
}));
//#endregion
//#region node_modules/@sendgrid/helpers/helpers/index.js
var require_helpers$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Export
	*/
	module.exports = {
		arrayToJSON: require_array_to_json(),
		convertKeys: require_convert_keys(),
		deepClone: require_deep_clone(),
		mergeData: require_merge_data(),
		splitNameEmail: require_split_name_email(),
		toCamelCase: require_to_camel_case(),
		toSnakeCase: require_to_snake_case(),
		wrapSubstitutions: require_wrap_substitutions()
	};
}));
//#endregion
//#region node_modules/@sendgrid/helpers/index.js
var require_helpers = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	module.exports = {
		...
		helpers: require_helpers$1()
	};
}));
//#endregion
//#region node_modules/@sendgrid/client/src/classes/client.js
var require_client$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var axios = require_axios();
	var pkg = (init_package(), __toCommonJS(package_exports).default);
	var { helpers: { mergeData }, classes: { Response, ResponseError } } = require_helpers();
	...
	var Client = class {
		...
		setApiKey(apiKey) {
			...
			if (!this.isValidApiKey(apiKey)) console.warn(`API key does not start with "${API_KEY_PREFIX}".`);
		}
		setTwilioEmailAuth(username, password) {
			...
			if (!this.isValidTwilioAuth(username, password)) console.warn("Twilio Email credentials must be non-empty strings.");
		}
		...
		**/
		setDataResidency(region) {
			if (!REGION_HOST_MAP.hasOwnProperty(region)) console.warn("Region can only be \"global\" or \"eu\".");
			else {
		...
		createHeaders(data) {
			...
			if (typeof headers.Authorization === "undefined" && this.auth) headers.Authorization = this.auth;
			if (this.impersonateSubuser) headers["On-Behalf-Of"] = this.impersonateSubuser;
			return headers;
		}
		createRequest(data) {
			let options = {
		...
		request(data, cb) {
			...
			const promise = new Promise((resolve, reject) => {
				axios(data).then((response) => {
					...
					if (error.response) {
						if (error.response.status >= 400) return reject(new ResponseError(error.response));
					}
					return reject(error);
				});
			});
			if (cb && typeof cb !== "function") throw new Error("Callback passed is not a function.");
			if (cb) return promise.then((result) => cb(null, result)).catch((error) => cb(error, null));
			return promise;
		}
	};
...
//#endregion
//#region node_modules/@sendgrid/client/src/client.js
var require_client$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = new (require_client$2())();
}));
//#endregion
//#region node_modules/@sendgrid/client/index.js
var require_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var client = require_client$1();
	var Client = require_client$2();
	module.exports = client;
	module.exports.Client = Client;
}));
//#endregion
export { require_helpers as n, require_client as t };
